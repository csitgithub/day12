...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="tbEmpName" class="form-control" id="txt_search_tbEmpName" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">人员性别 </span>
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">人员年龄 </span>
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">人员生日 </span>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>人员性别：</td>
								<td><input type="radio" id="tbEmpSex" name="tbEmpSex" value="1"
									class="" aria-required="true" required/>男
								</td>
								<td><input type="radio" id="tbEmpSex" name="tbEmpSex" value="0"
	...
	function initEditUser(getSelection){
		...
		//$('#tbEmpSex').val(getSelection.tbEmpSex);
